...
/**
 * A template for the flash player buttons. A basic setup will consist an icon,
 * alternate text, tool tip and action implementation.
 *
 * @author kumaresh
 * @version : "%I%, %G%"
 */
@SuppressWarnings("serial")
public class FlasherButton extends JButton
{
    /* Constants */
    /* Constants - Variables */
     ...
     */
    public FlasherButton(String iconPath, String toolTip,
